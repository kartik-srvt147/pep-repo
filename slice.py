...
class SlicingFloorPlan:
    ...
    def horizontal_cut(self, rectangle_name, top_rect, bottom_rect):
        leaf = self.search(self.root, rectangle_name)
        if leaf is None:
    ...
    def vertical_cut(self, rectangle_name, left_rect, right_rect):
        leaf = self.search(self.root, rectangle_name)
        if leaf is None:
            print("Rectangle not found")
            return
    ...
    def assign_dimensions(self, rectangle_name, width, height):
        leaf= self.search(self.root, rectangle_name)
        if leaf is None:
            print("Rectangle not found")
            return
